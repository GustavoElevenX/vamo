...
export default function PlatformLayout({
  ...
  useEffect(() => {
    ...
    const oldRouteRedirects: Record<string, string | Record<string, string>> = {
      ...
      '/criterios': '/configuracoes/kpis',
      '/missoes': role === 'seller' ? '/performance/missoes' : '/monitoramento/missoes',
      '/perfil-comportamental': role === 'seller' ? '/desenvolvimento/pdi' : '/monitoramento/desenvolvimento',
      '/ranking': home,
      '/desafios': home,
      '/padronizacao': home,
    }
