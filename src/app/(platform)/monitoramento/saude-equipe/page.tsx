    ...
    <div className="space-y-6">
      ...
      {burnoutCount > 0 && (
        <Card className="border-amber-500/20 bg-amber-500/5">
          <CardContent className="pt-5">
            <div className="flex items-start gap-3">
              <PauseCircle className="h-5 w-5 text-amber-500 mt-0.5 shrink-0" />
              <div>
      ...
      <Card className="border-border/50">
        ...
        <CardContent>
          <p className="text-xs text-muted-foreground mb-3">
            Como a equipe avalia a experiência com a plataforma? (Média das últimas respostas)
          </p>
          ...
          <div className="flex justify-between mt-2">
            <span className="text-[10px] text-muted-foreground">Insatisfeito</span>
            <span className="text-[10px] text-muted-foreground">Neutro</span>
            <span className="text-[10px] text-muted-foreground">Promotor</span>
          </div>
          <div className="mt-3 p-2.5 rounded-lg bg-background/50 border border-border/30">
            <p className="text-xs text-muted-foreground">
              <span className="font-medium text-foreground">Score atual: {npsScore}/10</span> ·{' '}
              {npsScore >= 9 ? 'Excelente! Equipe altamente engajada.' :
               npsScore >= 7 ? 'Bom. Equipe satisfeita com espaço para melhorar.' :
               npsScore >= 5 ? 'Atenção. Investigar pontos de insatisfação.' :
